  ...
  \begin{@twocolumnfalse}
    \maketitle
        \begin{abstract}
            ...
            telescope at the Asiago Observatory and, after proper correction, 
            we use them to extract the light curve of the alleged planet. Another 
            lightcurve is extracted basing on TESS observations, which include 
            multiple transit events. A radial velocity analysis yields further 
            insight on the mass and cinematical properties of the planet. 
...
two results. The O-C variation is in fact to little to justify the presence 
of any polluting signal.
...
Such errorbars on the jitter term make it far from significative, ensuring 
that the orbit is not being perturbed by any gravitational source.
...
the TESS prediction can be favoured over the on from 
