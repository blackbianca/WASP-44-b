...
to the models introduced by Claret.


In the configuration file for TASTE, priors taken from 
...
\begin{figure}[H]
	...
	\caption{Folded curve from the \textit{radial velocities} model.}
	\label{fig:RV1}
\end{figure}
...
This is verified by \ref{fig:ocplot} so the estimates are compati-
ble.
