...
\begin{figure}[H]
  \centering
    ...
    \label{fig:ocplot}
\end{figure}
The plot shows the propagation of the error on TESS prediction,
...
\end{table}
They yield very 
similar results both in terms of value and error (full results in 
\ref{sect:app_C_RV}), but the simplest model yields results with slightly 
smaller errrobars. These are a period $P=2.42381\pm0.00002d$
...
\section{Conclusions}
Best estimates for P and Tc, check with literature
conclude something about LD coefficients
...
\begin{figure}[H]
    \centering
      \includegraphics[scale=0.3, angle=0]{../pictures/RV/WASP44_RV_cornerplot.pdf}
...
\begin{figure}[H]
    \centering
      \includegraphics[scale=0.3, angle=0]{../pictures/RV/WASP44_RV_harmonics_cornerplot.pdf}
